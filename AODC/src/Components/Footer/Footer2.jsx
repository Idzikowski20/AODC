                    ...
                    <div className="row align-items-center">
                        ...
                        <div className="col-xl-5 col-lg-5 col-md-12 order-3 order-lg-2">
                            <div className="jm-footer-copyright-text-3 text-center">
                                <p>&copy; Copyright 2024 AODC Sp. z o.o. - Wszelkie prawa zastrzeżone. Stworzone przez <Link to="https://themeforest.net/user/codebasket/portfolio" target="_blank">Patryk Idzikowski</Link>.</p>
                            </div>
                        </div>
